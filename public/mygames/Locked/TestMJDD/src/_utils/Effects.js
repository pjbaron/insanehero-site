...
Effects.prototype.add = function( _type, _attached, _xoff, _yoff )
{
    ...
    // TODO: shrinks game effects when in low resolution mode (replace with low resolution animation)
    if ( Main.lowResolutionAssets && _type != Effects.PRELOADER )
        effect.scale.set(effect.scale.x * 0.5, effect.scale.y * 0.5);
