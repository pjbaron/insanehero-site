...
function Main()
{
    ...
    Main.VERSION = "v1.12t";     // TODO: update this for every release
    ...
    // useFocus : boolean
    // There have been problems calling the PIXI focus function Main.app.view.focus();
    // where some browsers/sites scroll the game vertically on start-up.
    // Set this to false to prevent these calls (from Main.getFocus())
    Main.useFocus = false;
