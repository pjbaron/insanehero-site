...
return!0}};var TWEEN=new _Group();TWEEN.Group=_Group;TWEEN._nextId=0;TWEEN.nextId=function(){return TWEEN._nextId++};if(typeof(self)==='undefined'&&typeof(process)!=='undefined'&&process.hrtime){TWEEN.now=function(){var time=process.hrtime();return time[0]*1000+time[1]/1000000}}
...
if(this._onUpdateCallback!==null){this._onUpdateCallback(this._object,elapsed)}
...
if(this._onRepeatCallback!==null){this._onRepeatCallback(this._object)}
